        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h5>Pesanan anda sudah sukses dicheck out selanjutnya untuk pembayaran silahkan transfer di rekening <strong>Bank BCA Nomer Rekening : 0844-468215-753</strong> dengan nominal : <strong>Rp. {{ number_format($pesanan->kode+$pesanan->jumlah_harga) }}</strong></h5>
                                {{ QrCode::size(250)->generate('http://127.0.0.1:8000/check-out') }}
                </div>
            </div>
            <div class="card mt-2">
                <div class="card-body">
